...
class BaseTrainer:
    ...
    def _run_epoch(self, mode):
        ...
        """
        for metric in self.metric_fns: metric.reset_count()
        ...
        # print(self.metric_fns[1].get_name())
        # {metric.get_name():metric(logits, labels.view(-1)) for metric in self.metric_fns}
